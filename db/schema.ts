...
export const bomProductionRunItemsTable = pgTable(
  "bom_production_run_items",
  {
    ...
    consumedQuantity: numeric("consumed_quantity", { precision: 12, scale: 3 }).notNull(),
...
export const stockOpnameDetailsTable = pgTable(
  "stock_opname_details",
  {
    ...
    cashierActual: numeric("cashier_actual", { precision: 12, scale: 3 }),
    chefActual: numeric("chef_actual", { precision: 12, scale: 3 }),
    waitersActual: numeric("waiters_actual", { precision: 12, scale: 3 }),
    finalActual: numeric("final_actual", { precision: 12, scale: 3 }),
...
export const stockOpnameItemSummariesTable = pgTable(
  "stock_opname_item_summaries",
  {
    ...
    systemStockBefore: numeric("system_stock_before", { precision: 12, scale: 3 }).notNull(),
    totalRoleActual: numeric("total_role_actual", { precision: 12, scale: 3 }),
    finalActual: numeric("final_actual", { precision: 12, scale: 3 }),
...
export const aiWeeklyStockProjectionsTable = pgTable(
  "ai_weekly_stock_projections",
  {
    ...
    predictedWeeklyUsage: numeric("predicted_weekly_usage", { precision: 12, scale: 3 }).notNull(),
    predictedEndingStock: numeric("predicted_ending_stock", { precision: 12, scale: 3 }).notNull(),
    stockCoverDays: numeric("stock_cover_days", { precision: 12, scale: 3 }).notNull(),
...
export const aiBuyRecommendationsTable = pgTable(
  "ai_buy_recommendations",
  {
    ...
    recommendedQuantity: numeric("recommended_quantity", { precision: 12, scale: 3 }).notNull(),
